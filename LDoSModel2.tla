...
CONSTANT Sender, Receiver, Router, Packet, AttackerPacket
                                                                                                           
VARIABLES router_queue, attacker_data, attacker_pc, attacker_ubTimer, attacker_lbTimer,
...
vars == <<router_queue, attacker_data, attacker_pc, attacker_ubTimer, attacker_lbTimer,
          \*Sender  established after  Relation -------------------------------------------------
          mss, sequencenumber, window_size, data,         
          \*Packet Relation ---------------------------------------------------------------------
          pc, packet_sequencenumber, packet_data, 
...
Init == \*Sender = portnumber? established before determination
        ...
        \*Attacker
        /\attacker_data    = [a \in AttackerPacket |-> 1000*Cardinality(Packet)]
...
Attackers(a) == /\IF ((now % 1000) = 0)
                     THEN
                         ...
                         /\UNCHANGED<<router_queue, attacker_data,
                                      mss, sequencenumber, window_size, data,         
                                      pc, packet_sequencenumber, packet_data, 
                                      rtpacket_pc1, rtpacket_sequencenumber1, rtpacket_data1, 
                                      rtpacket_pc2, rtpacket_sequencenumber2, rtpacket_data2, 
                                      ...
                                      received_data, received_sequencenumber>>
                     ELSE
                         /\UNCHANGED<<router_queue, attacker_data, attacker_pc, attacker_ubTimer, attacker_lbTimer,
                                      mss, sequencenumber, window_size, data,         
                                      pc, packet_sequencenumber, packet_data, 
                                      rtpacket_pc1, rtpacket_sequencenumber1, rtpacket_data1, 
                                      rtpacket_pc2, rtpacket_sequencenumber2, rtpacket_data2, 
...
AttackerSendingToRouter(a) == /\SetTimer(a, attacker_ubTimer, 100)
...
AttackerRouters(a) == /\SetTimer(a, attacker_ubTimer, 100)
                      /\TimedOut(a, attacker_lbTimer)
                      /\SetTimer(a, attacker_lbTimer, 100)
...
AttackerSendingToReceiver(a) == /\SetTimer(a, attacker_ubTimer, 100)
                                /\TimedOut(a, attacker_lbTimer)
                                /\SetTimer(a, attacker_lbTimer, 100)
...
AttackerReceivers(a) == /\TimedOut(a, attacker_lbTimer)
                        /\ResetUBTimer(a,attacker_ubTimer)
                        /\GoFromTo(a, "AttackerReceivers", "Attacker", attacker_pc)
                        /\UNCHANGED<<router_queue, attacker_data, attacker_lbTimer,
                                      mss, sequencenumber, window_size, data,         
                                      pc, packet_sequencenumber, packet_data, 
                                      rtpacket_pc1, rtpacket_sequencenumber1, rtpacket_data1, 
                                      rtpacket_pc2, rtpacket_sequencenumber2, rtpacket_data2, 
...
Tick == 
 \E d \in PosReal:
     ...
     /\ \A p \in Packet: rto[p] > rto_countTimer[p] 
      ...
      \* delete UNCHANGED
     /\UNCHANGED <<router_queue, attacker_data, attacker_pc,
...
UDP(a) == \/Attackers(a)\/AttackerSendingToRouter(a)
          \/AttackerRouters(a)\/AttackerSendingToReceiver(a)\/AttackerReceivers(a)

      
SPNext(s,p,r,a) == \/Senders(s,p)\/SendingToRouter(p)\/Routers(p)
...
\* Last modified Mon Jan 15 15:49:50 JST 2024 by yamatani
\* Created Mon Jan 15 14:02:14 JST 2024 by yamatani
